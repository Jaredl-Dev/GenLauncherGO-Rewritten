...
internal sealed class FileSystemLocalLauncherContentService : ILocalLauncherContentService
{
    ...
    public void DeleteEmptyPackageBackupDirectories(LauncherPaths paths)
    {
        ...
        {
            _logger.LogDebug("Deleted the empty launcher package recovery directory.");
        }
    }
        ...
        LauncherData launcherData)
    {
        ...
        string imageFolderPath = ModificationImageCachePath.GetDirectoryPath(
            paths,
        ...
        List<LauncherContentVersion> versions)
    {
        ...
        {
            ModificationType? childContentType =
                LauncherContentPathResolver.ResolveChildContentType(subDirectory.Name);
